...
<!--Script for Weather updates-->
<script>
    async function fetchWeather() {
        const apiKey = 'd003e00fa1875766c93f10700487869e';
        ...
        try {
            ...
            document.getElementById('weather').innerHTML = '<p>❌ Failed Loading.</p>';
        }
    }
...
<!--Script for Weather updates End-->
