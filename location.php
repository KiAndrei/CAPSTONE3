        ...
        <div class="container">
            <div id="map-container">
                ...
                <iframe 
                    ...
                    allowfullscreen="" 
                    loading="lazy"
                    src="https://www.openstreetmap.org/export/embed.html?bbox=121.1151%2C14.2686%2C121.1351%2C14.2886&layer=mapnik&marker=14.2786,121.1251">
                </iframe>
                </div>
                <div class="location-details">
                <h3><i class="fas fa-map-marker-alt"></i> Your Location</h3>
                <p><i class="fas fa-map-pin"></i> <strong>Address:</strong> 123 Your Street, Your City</p>
                <p><i class="fas fa-globe"></i> <strong>Coordinates:</strong> <span id="coordinates"></span></p>
                <p><i class="fas fa-landmark"></i> <strong>Nearby Landmarks:</strong> Example Landmark</p>
            </div>
